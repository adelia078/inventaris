            ...
            <div class="alert alert-info">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="mb-2"><strong>Nama Barang:</strong> {{ $peminjaman->barang->nama }}</p>
                        <p class="mb-2"><strong>Kode Barang:</strong> {{ $peminjaman->barang->kode_barang }}</p>
                        <p class="mb-2"><strong>Jumlah Dipinjam:</strong> {{ $peminjaman->jumlah_dipinjam }} Unit</p>
                    </div>
                    <div class="col-md-6">
                        <p class="mb-2"><strong>Peminjam:</strong> {{ $peminjaman->nama_peminjam }}</p>
                        <p class="mb-2"><strong>Tanggal Pinjam:</strong> {{ $peminjaman->tanggal_pinjam->format('d F Y') }}</p>
                        <p class="mb-2"><strong>Tanggal Kembali (Rencana):</strong> {{ $peminjaman->tanggal_kembali_rencana->format('d F Y') }}</p>
            ...
            <form action="{{ route('peminjaman.update-kembali', $peminjaman->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="keterangan_kembali" class="form-control" rows="4" 
                                  placeholder="Catatan kondisi barang, alasan keterlambatan (jika ada), dll...">{{ old('keterangan_kembali') }}</textarea>
                ...
                <div class="alert alert-warning">
                    ...
                    Tanggal kembali seharusnya: {{ $peminjaman->tanggal_kembali_rencana->format('d F Y') }}
                </div>
                @endif
